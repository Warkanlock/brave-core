...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
    ...
    {"changeIpfsStorageMaxLabel",
     IDS_SETTINGS_CHANGE_IPFS_STORAGE_MAX_LABEL},
    {"changeIpfsStorageMaxDesc",
     IDS_SETTINGS_CHANGE_IPFS_STORAGE_MAX_DESC},
  ...
  html_source->AddString(
      ...
      base::ASCIIToUTF16(
          google_util::AppendGoogleLocaleParam(
              ...
              .spec()));
  html_source->AddString("ipfsStorageMaxValue",std::to_string(
        profile->GetPrefs()->GetInteger(kIpfsStorageMax)));
}
